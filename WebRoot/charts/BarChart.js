jQuery.sap.declare("hcpcu.charts.BarChart");

sap.ui.core.Element.extend("hcpcu.charts.BarChartItem", { metadata : {
	properties   : {
...
sap.ui.core.Control.extend("hcpcu.charts.BarChart", {
	metadata : {
		properties: {
			"title" : { type : "string", group : "Misc", defaultValue : "Chart Title"}
		},
		aggregations : {
			"items" : { type : "hcpcu.charts.BarChartItem", multiple : true, singularName : "item"}
		},
