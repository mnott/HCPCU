...
public class FileLoader {
   ...
   * The Log4J Logger.
   */
  static private Logger log = LoggerFactory.getLogger(FileLoader.class);
  ...
  public static InputStream load(String name) {
    ...
    try {
      ...
      log.error("! Did not find the resource " + name);
  ...
  public static Properties loadProperties(String name) {
    ...
    try {
      ...
      if (is == null) {
        log.error("! Error reading file: " + name);
      ...
      log.error("! Error reading file " + name + ": " + e.getMessage());
